...
(The data is showing student / customer data )
...
```{r}
student2 <- glm(default ~ income + balance, data = default, family = binomial)
summary(student2)
```
...
```{r}
defaultmodel <- glm(default ~ income, data = default, family = binomial)
